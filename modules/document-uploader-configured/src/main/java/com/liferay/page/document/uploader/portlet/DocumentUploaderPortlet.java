...
@Component(
        property = {
                ...
                "javax.portlet.display-name=DocumentUploaderConfigured",
...
public class DocumentUploaderPortlet extends MVCPortlet {
    ...
    public void render(RenderRequest renderRequest, RenderResponse renderResponse) throws IOException, PortletException {
        ...
        renderRequest.setAttribute("folderTrees", DocumentUploaderUtil.getDLFolderTrees(DLFolderLocalServiceUtil.getDLFolders(QueryUtil.ALL_POS,QueryUtil.ALL_POS)));
