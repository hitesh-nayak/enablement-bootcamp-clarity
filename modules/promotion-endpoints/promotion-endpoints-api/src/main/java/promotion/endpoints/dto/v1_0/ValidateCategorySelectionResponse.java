 ...
 */
@Generated("")
@GraphQLName("ValidateCategorySelectionResponse")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ValidateCategorySelectionResponse")
public class ValidateCategorySelectionResponse implements Serializable {

	public static ValidateCategorySelectionResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ValidateCategorySelectionResponse.class, json);
	}

	public static ValidateCategorySelectionResponse unsafeToDTO(String json) {
	...
	@Schema(
		...
		defaultValue = "promotion.endpoints.dto.v1_0.ValidateCategorySelectionResponse",
		name = "x-class-name"
	)
