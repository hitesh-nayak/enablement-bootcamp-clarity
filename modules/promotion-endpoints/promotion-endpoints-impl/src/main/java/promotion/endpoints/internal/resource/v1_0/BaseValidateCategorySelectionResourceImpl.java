...
public abstract class BaseValidateCategorySelectionResourceImpl
	implements ValidateCategorySelectionResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/promotion-endpoints/v1.0/validatePromotionCategory'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "ValidateCategorySelection"
			)
		}
	)
	@javax.ws.rs.Consumes("multipart/form-data")
	@javax.ws.rs.Path("/validatePromotionCategory")
	@javax.ws.rs.POST
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseValidateCategorySelectionResourceImpl.class);
