...
public class DLAdminDisplayContextCustom {

	public DLAdminDisplayContextCustom(
	...
	public String getDisplayStyle() {
		...
		String[] displayViews = _dlPortletInstanceSettingsCustom.getDisplayViews();
	...
	public long getRepositoryId() {
		...
		if (folder != null) {
			...
			repositoryId = _dlPortletInstanceSettingsCustom.getSelectedRepositoryId();
		}
	...
	public long getSelectedRepositoryId() {
		...
		long repositoryId =
			_dlPortletInstanceSettingsCustom.getSelectedRepositoryId();
	...
	private void _computeRootFolder() {
		_rootFolderId = _dlPortletInstanceSettingsCustom.getRootFolderId();
		...
		try {
			...
			PageFolderMappingUtil.validateDepotFolder(
	...
	private SearchContainer<RepositoryEntry> _getDLSearchContainer()
		...
		SearchContainer<RepositoryEntry> dlSearchContainer =
			new SearchContainer<>(
				...
				_dlPortletInstanceSettingsCustom.getEntriesPerPage(), portletURL,
				null, emptyResultsMessage);

		dlSearchContainer.setHeaderNames(
			ListUtil.fromArray(
				_dlPortletInstanceSettingsHelperCustom.getEntryColumns()));
	...
	private String _getPortletPreference(String name, String defaultValue) {
		...
		return GetterUtil.getString(
			_httpSession.getAttribute(
				_dlRequestHelperCustom.getPortletId() + StringPool.UNDERLINE + name),
			defaultValue);
	}
	...
	private PortletPreferences _getPortletPreferences() {
		...
		_portletPreferences =
			PortletPreferencesFactoryUtil.getLayoutPortletSetup(
				...
				_dlRequestHelperCustom.getPortletId(), StringPool.BLANK);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DLAdminDisplayContextCustom.class);

	private final AssetAutoTaggerConfiguration _assetAutoTaggerConfiguration;
	private boolean _defaultFolderView;
	private String _displayStyle;
	private final DLPortletInstanceSettingsCustom _dlPortletInstanceSettingsCustom;
