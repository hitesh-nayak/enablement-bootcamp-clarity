...
public class DLAdminManagementToolbarDisplayContextCustom
	...
	public DLAdminManagementToolbarDisplayContextCustom(
		...
		DLTrashHelperCustom dlTrashHelperCustom) {

		super(
			httpServletRequest, liferayPortletRequest, liferayPortletResponse,
			dlAdminDisplayContextCustom.getSearchContainer());

		_httpServletRequest = httpServletRequest;
		_liferayPortletRequest = liferayPortletRequest;
		_liferayPortletResponse = liferayPortletResponse;
		_dlAdminDisplayContextCustom = dlAdminDisplayContextCustom;
		_dlTrashHelperCustom = dlTrashHelperCustom;

		_currentURLObj = PortletURLUtil.getCurrent(
			liferayPortletRequest, liferayPortletResponse);

		_dlRequestHelperCustom = new DLRequestHelperCustom(_httpServletRequest);

		_dlPortletInstanceSettingsHelperCustom = new DLPortletInstanceSettingsHelperCustom(
				_dlRequestHelperCustom);
	...
	public List<DropdownItem> getActionDropdownItems() {
		if (!_dlPortletInstanceSettingsHelperCustom.isShowActions()) {
			return null;
		}
	...
	public String getSortingOrder() {
		...
		return _dlAdminDisplayContextCustom.getOrderByType();
	}
	...
	public Boolean isShowSearch() {
		if (_dlPortletInstanceSettingsHelperCustom.isShowSearch() &&
			super.isShowSearch()) {
	...
	private String _getDisplayStyle() {
		return _dlAdminDisplayContextCustom.getDisplayStyle();
	}
	...
	private String[] _getDisplayViews() {
		...
		return dlPortletInstanceSettingsCustom.getDisplayViews();
	}
	...
	private long _getFolderId() {
		...
		return _dlAdminDisplayContextCustom.getFolderId();
	}
	...
	private String _getOrderByCol() {
		return _dlAdminDisplayContextCustom.getOrderByCol();
	}
	...
	private long _getRepositoryId() {
		return _dlAdminDisplayContextCustom.getRepositoryId();
	}
	...
	private boolean _isSearch() {
		return _dlAdminDisplayContextCustom.isSearch();
	}
	...
	private final DLAdminDisplayContextCustom _dlAdminDisplayContextCustom;
	private final DLPortletInstanceSettingsHelperCustom
			_dlPortletInstanceSettingsHelperCustom;
	private final DLRequestHelperCustom _dlRequestHelperCustom;
	private final DLTrashHelperCustom _dlTrashHelperCustom;
	...
	public String toString() {
		return "DLAdminManagementToolbarDisplayContext{" +
				"_currentURLObj=" + _currentURLObj +
				", _dlAdminDisplayContext=" + _dlAdminDisplayContextCustom +
				", _dlPortletInstanceSettingsHelper=" + _dlPortletInstanceSettingsHelperCustom +
				", _dlRequestHelper=" + _dlRequestHelperCustom +
				", _dlTrashHelper=" + _dlTrashHelperCustom +
				", _hasValidAssetVocabularies=" + _hasValidAssetVocabularies +
				", _httpServletRequest=" + _httpServletRequest +
				", _liferayPortletRequest=" + _liferayPortletRequest +
				", _liferayPortletResponse=" + _liferayPortletResponse +
				", _themeDisplay=" + _themeDisplay +
				'}';
	}
}