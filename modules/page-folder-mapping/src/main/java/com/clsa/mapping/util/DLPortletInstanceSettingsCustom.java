...
public class DLPortletInstanceSettingsCustom {

	public static DLPortletInstanceSettingsCustom getInstance(
		...
		return new DLPortletInstanceSettingsCustom(settings);
	}
	...
	public static DLPortletInstanceSettingsCustom getInstance(
		...
		return new DLPortletInstanceSettingsCustom(parameterMapSettings);
	}

	public static void registerSettingsMetadata() {
		SettingsFactoryUtil.registerSettingsMetadata(
			DLPortletInstanceSettingsCustom.class, null, _getFallbackKeys());
	}

	public DLPortletInstanceSettingsCustom(Settings settings) {
