...
import com.liferay.employee.service.model.EmployeeTable;
import com.liferay.employee.service.model.impl.EmployeeImpl;
import com.liferay.employee.service.model.impl.EmployeeModelImpl;
import com.liferay.employee.service.service.persistence.EmployeePersistence;
import com.liferay.employee.service.service.persistence.EmployeeUtil;
...
public class EmployeePersistenceImpl
	...
	public Employee[] findByUuid_PrevAndNext(
		...
		Employee employee = findByPrimaryKey(companyEmpId);
	 ...
	 */
	@Override
	public List<Employee> findByEmpLastName(String empLastName) {
	 ...
	 */
	@Override
	public List<Employee> findByEmpLastName(
	...
	public List<Employee> findByEmpLastName(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Employee employee : list) {
					if (!empLastName.equals(employee.getEmpLastName())) {
						list = null;
	...
	public Employee findByEmpLastName_First(
		...
		Employee employee = fetchByEmpLastName_First(
	...
	public Employee fetchByEmpLastName_First(
		...
		List<Employee> list = findByEmpLastName(
	...
	public Employee findByEmpLastName_Last(
		...
		Employee employee = fetchByEmpLastName_Last(
			empLastName, orderByComparator);
	...
	public Employee[] findByEmpLastName_PrevAndNext(
		...
		try {
			...
			array[0] = getByEmpLastName_PrevAndNext(
				session, employee, empLastName, orderByComparator, true);

			array[1] = employee;

			array[2] = getByEmpLastName_PrevAndNext(
				session, employee, empLastName, orderByComparator, false);
	...
	protected Employee getByEmpLastName_PrevAndNext(
		Session session, Employee employee, String empLastName,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_EMPLASTNAME_EMPLASTNAME_3 =
		"(employee.empLastName IS NULL OR employee.empLastName = '')";
	...
	public Employee findByCompanyEmpId(long companyEmpId)
		...
		Employee employee = fetchByCompanyEmpId(companyEmpId);
	...
	public Employee fetchByCompanyEmpId(
		...
		if (result instanceof Employee) {
			...
			if (companyEmpId != employee.getCompanyEmpId()) {
				result = null;
			}
		}
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"EmployeePersistenceImpl.fetchByCompanyEmpId(long, boolean) with parameters (" +
	...
	public Employee removeByCompanyEmpId(long companyEmpId)
		...
		Employee employee = findByCompanyEmpId(companyEmpId);
	 ...
	 */
	@Override
	public List<Employee> findByCompanyName(
	...
	public List<Employee> findByCompanyName(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Employee employee : list) {
					if (!companyName.equals(employee.getCompanyName())) {
						list = null;
	...
	public Employee findByCompanyName_First(
		...
		Employee employee = fetchByCompanyName_First(
	...
	public Employee fetchByCompanyName_First(
		...
		List<Employee> list = findByCompanyName(
	...
	public Employee findByCompanyName_Last(
		...
		Employee employee = fetchByCompanyName_Last(
			companyName, orderByComparator);
	...
	public Employee[] findByCompanyName_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyName_PrevAndNext(
				session, employee, companyName, orderByComparator, true);

			array[1] = employee;

			array[2] = getByCompanyName_PrevAndNext(
				session, employee, companyName, orderByComparator, false);
	...
	protected Employee getByCompanyName_PrevAndNext(
		Session session, Employee employee, String companyName,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_COMPANYNAME_COMPANYNAME_3 =
		"(employee.companyName IS NULL OR employee.companyName = '')";
	...
	public void cacheResult(Employee employee) {
		...
		finderCache.putResult(
			...
			new Object[] {employee.getCompanyEmpId()}, employee);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {employeeModelImpl.getCompanyEmpId()};

		finderCache.putResult(
			_finderPathCountByCompanyEmpId, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByCompanyEmpId, args, employeeModelImpl);
	}
	...
	public Employee create(long companyEmpId) {
		...
		employee.setPrimaryKey(companyEmpId);
