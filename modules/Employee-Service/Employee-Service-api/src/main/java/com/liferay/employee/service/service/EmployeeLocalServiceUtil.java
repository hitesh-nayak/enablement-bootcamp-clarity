 ...
 * <code>com.liferay.employee.service.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.employee.service.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Employee createEmployee(long companyEmpId) {
		return getService().createEmployee(companyEmpId);
	}
	 ...
	 */
	public static Employee deleteEmployee(long companyEmpId)
		throws PortalException {

		return getService().deleteEmployee(companyEmpId);
	}
	...
	public static Employee fetchEmployee(long companyEmpId) {
	 ...
	 * @throws PortalException if a employee with the primary key could not be found
	 */
	public static Employee getEmployee(long companyEmpId)
		throws PortalException {

		return getService().getEmployee(companyEmpId);
	}
