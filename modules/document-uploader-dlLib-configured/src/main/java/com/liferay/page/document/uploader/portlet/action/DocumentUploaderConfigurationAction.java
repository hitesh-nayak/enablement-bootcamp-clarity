...
public class DocumentUploaderConfigurationAction extends DefaultConfigurationAction  {
    ...
    public void processAction(
            ...
            throws Exception {
        //setPreference(actionRequest, "folderId", ParamUtil.getString(actionRequest, "rootFolderName"));
        setPreference(actionRequest, "folderId", ParamUtil.getString(actionRequest, "folderUploadId"));
        //setPreference(actionRequest, "folderId", ParamUtil.getString(actionRequest, "folderUploadId"));
