...
public class DLAdminDisplayContext {
	...
	public String toString() {
		return "DLAdminDisplayContext{" +
				"_assetAutoTaggerConfiguration=" + _assetAutoTaggerConfiguration +
				", _defaultFolderView=" + _defaultFolderView +
				", _displayStyle='" + _displayStyle + '\'' +
				", _dlPortletInstanceSettings=" + _dlPortletInstanceSettings +
				", _dlPortletInstanceSettingsHelper=" + _dlPortletInstanceSettingsHelper +
				", _dlRequestHelper=" + _dlRequestHelper +
				", _folder=" + _folder +
				", _folderId=" + _folderId +
				...
				", _orderByCol='" + _orderByCol + '\'' +
				", _orderByType='" + _orderByType + '\'' +
				", _permissionChecker=" + _permissionChecker +
				", _portalPreferences=" + _portalPreferences +
				", _portletPreferences=" + _portletPreferences +
				", _repositoryId=" + _repositoryId +
				", _rootFolderId=" + _rootFolderId +
				", _rootFolderInTrash=" + _rootFolderInTrash +
				", _rootFolderName='" + _rootFolderName + '\'' +
				", _rootFolderNotFound=" + _rootFolderNotFound +
				", _searchContainer=" + _searchContainer +
				", _selectedRepositoryId=" + _selectedRepositoryId +
				", _themeDisplay=" + _themeDisplay +
				", _trashHelper=" + _trashHelper +
				", _versioningStrategy=" + _versioningStrategy +
				'}';
	}
}