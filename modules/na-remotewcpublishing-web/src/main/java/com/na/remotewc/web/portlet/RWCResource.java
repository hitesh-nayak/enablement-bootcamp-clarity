...
import com.na.remotewc.web.util.WebContentDtoUtil;
...
@Component(immediate = true, property = { "javax.portlet.name=" + RWCPortletKeys.RWC,
"mvc.command.name=/serve/webcontentjson" }, service = MVCResourceCommand.class)

public class RWCResource implements MVCResourceCommand {
	
	private static Log log = LogFactoryUtil.getLog(RWCResource.class);
