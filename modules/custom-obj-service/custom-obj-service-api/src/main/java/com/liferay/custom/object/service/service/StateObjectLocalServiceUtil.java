...
/**
 * Provides the local service utility for StateObject. This utility wraps
 * <code>com.liferay.custom.object.service.service.impl.StateObjectLocalServiceImpl</code> and
 ...
 * @generated
 */
public class StateObjectLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.custom.object.service.service.impl.StateObjectLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static StateObject addStateObject(StateObject stateObject) {
		return getService().addStateObject(stateObject);
	}
	 ...
	 */
	public static StateObject createStateObject(long stateId) {
		return getService().createStateObject(stateId);
	}
	 ...
	 */
	public static StateObject deleteStateObject(long stateId)
		throws PortalException {

		return getService().deleteStateObject(stateId);
	}
	 ...
	 * @return the state object that was removed
	 */
	public static StateObject deleteStateObject(StateObject stateObject) {
		return getService().deleteStateObject(stateObject);
	}
	...
	public static StateObject fetchStateObject(long stateId) {
		return getService().fetchStateObject(stateId);
	}
	 ...
	 * @throws PortalException if a state object with the primary key could not be found
	 */
	public static StateObject getStateObject(long stateId)
		throws PortalException {

		return getService().getStateObject(stateId);
	}
	 ...
	 */
	public static List<StateObject> getStateObjects(int start, int end) {
		return getService().getStateObjects(start, end);
	}
	 ...
	 */
	public static int getStateObjectsCount() {
		return getService().getStateObjectsCount();
	}
	 ...
	 */
	public static StateObject updateStateObject(StateObject stateObject) {
		return getService().updateStateObject(stateObject);
	}

	public static StateObjectLocalService getService() {
		return _service;
	}

	public static void setService(StateObjectLocalService service) {
		_service = service;
	}

	private static volatile StateObjectLocalService _service;
